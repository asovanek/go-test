...
import (
	...
	"github.com/example/authapp/backend/docs"
	"github.com/example/authapp/backend/internal/migrator"
	"github.com/example/authapp/backend/internal/platform/config"
	"github.com/example/authapp/backend/internal/platform/database"
	"github.com/example/authapp/backend/internal/platform/events"
	"github.com/example/authapp/backend/internal/platform/logger"
	platformvalidator "github.com/example/authapp/backend/internal/platform/validator"
	"github.com/example/authapp/backend/internal/router"
	"github.com/example/authapp/backend/internal/subscribers"
	"go.uber.org/zap"
)
